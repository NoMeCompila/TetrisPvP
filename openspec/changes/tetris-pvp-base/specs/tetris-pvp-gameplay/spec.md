...
Each player's active piece SHALL descend at a steady gravity tick rate. Players SHALL be able to shift pieces left, right, and rotate 90 degrees clockwise within board boundaries. Soft drop SHALL NOT be permitted.
...
- **WHEN** Player 1 presses `S` or Player 2 presses `K`
